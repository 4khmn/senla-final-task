...
public class AdvertisementController {
    ...
    public ResponseEntity<List<AdvertisementResponseDto>> getAllAdvertisements() {
        ...
        log.info("GET /api/advertisements - All advertisements successfully retrieved");
    ...
    public ResponseEntity<AdvertisementResponseDto> createAdvertisement(
        ...
        log.info("POST /api/advertisements - User with username = {} trying to create an advertisement {}", user.getUsername(), dto);
        AdvertisementResponseDto advertisement = advertisementService.create(dto, user.getUsername());
        log.info("POST /api/advertisements - Advertisement with id = {} successfully created for user with username = {}", advertisement.id(), user.getUsername());
